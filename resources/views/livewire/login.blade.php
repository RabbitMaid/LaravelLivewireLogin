    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        ...
        <div class="w-50 mx-auto px-11 md:px-0">
            ...
            <form wire:submit.prevent="auth">
                ...
                <input type="email" wire:model="email" placeholder="Email" class="min-w-full mb-2 p-2 border border-slate-600 mx-auto">

                @error('email')
                    <span class="text-red-800 inline-block mb-3">{{ $message }}</span>
                @enderror

                <input type="password" wire:model="password" placeholder="Password" class="min-w-full mb-2 p-2 border border-slate-600">
